        ...
        <div className='text-white bg-black'>
            <div className="mt-[-95px] w-full h-screen mx-auto text-center flex flex-col justify-center">
                ...
                <div className="flex justify-center items-center">
                    <p className='md:text-2xl text-xl font-bold text-cyan-300'>Create your special </p>
                    <Typed className='md:text-2xl text-xl font-bold pl-2 text-cyan-300' strings={['smiles', 'teeth', 'smiles', 'teeth', 'smiles', 'teeth', 'smiles', 'teeth', 'smiles']} typeSpeed={110} backSpeed={130} />
                </div>
